...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set led_out_0 [ create_bd_port -dir O -from 3 -to 0 led_out_0 ]
  set switch_in_0 [ create_bd_port -dir I -from 3 -to 0 switch_in_0 ]

  # Create instance: myip_led_switch_0, and set properties
  set myip_led_switch_0 [ create_bd_cell -type ip -vlnv user.org:user:myip_led_switch:1.0 myip_led_switch_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins myip_led_switch_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net myip_led_switch_0_led_out [get_bd_ports led_out_0] [get_bd_pins myip_led_switch_0/led_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins myip_led_switch_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins myip_led_switch_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net switch_in_0_1 [get_bd_ports switch_in_0] [get_bd_pins myip_led_switch_0/switch_in]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myip_led_switch_0/S00_AXI/S00_AXI_reg] SEG_myip_led_switch_0_S00_AXI_reg
