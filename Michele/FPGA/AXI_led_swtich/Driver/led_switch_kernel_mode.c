...
* -----------------------------------
* Quando l'utente utilizza il comando "cat" con una stringa verso /proc/my_lsw,
...
* Scrive il valore nel registro permettendo ai led di accendersi.
*/
static ssize_t proc_myled_write(struct file *file, const char __user * buf, size_t count, loff_t * ppos){
...
static const struct of_device_id myled_of_match[] = {
	{.compatible = "xlnx,myip-led-switch-1.0"},
	{},
};
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION(DRIVER_NAME ": MY_LED_SWITCH driver");
