...
/* Write operation for /proc/GPIO_1
* --------------------------------------
*/
...
/* Callback function when opening file /proc/GPIO_1
* ------------------------------------------------------
*/
...
/* File Operations for /proc/GPIO_1 */
