...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S_AXI_INTR is
  port (
    ...
    into_detect : in STD_LOGIC_VECTOR ( 0 to 0 );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_cu is
  port (
    ...
    into_detect : out STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_cu is
  ...
  attribute SOFT_HLUTNM of tx_busy_detector_i_1 : label is "soft_lutpair11";
begin
...
tx_busy_detector_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
