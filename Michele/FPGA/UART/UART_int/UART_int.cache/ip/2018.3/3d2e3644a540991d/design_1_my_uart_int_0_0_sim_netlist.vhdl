...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Detector is
  port (
    \last_stage_reg[0]_0\ : out STD_LOGIC;
    rda_to_intr : in STD_LOGIC;
    s_axi_intr_aclk : in STD_LOGIC;
    det_intr : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Detector;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Detector is
  signal current_stage : STD_LOGIC_VECTOR ( 0 to 0 );
  signal first_stage : STD_LOGIC_VECTOR ( 0 to 0 );
  signal last_stage : STD_LOGIC_VECTOR ( 0 to 0 );
begin
...
\first_stage_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_intr_aclk,
      CE => '1',
      D => rda_to_intr,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S_AXI_INTR is
  ...
  signal tx_busy_detector_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  ...
  attribute SOFT_HLUTNM of \axi_arready_i_1__0\ : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of \axi_rvalid_i_1__0\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \axi_wready_i_1__0\ : label is "soft_lutpair23";
...
tx_busy_detector: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Detector
     port map (
      det_intr => det_intr,
      \last_stage_reg[0]_0\ => tx_busy_detector_n_0,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_cu is
  ...
  attribute SOFT_HLUTNM of \first_stage[0]_i_1\ : label is "soft_lutpair11";
begin
...
\first_stage[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
