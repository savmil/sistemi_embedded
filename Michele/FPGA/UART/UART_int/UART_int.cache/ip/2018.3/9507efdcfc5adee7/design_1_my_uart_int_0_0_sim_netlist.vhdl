...
-- Date        : Mon Apr 29 18:22:55 2019
-- Host        : andrea-X580VD running 64-bit Ubuntu 18.04.2 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_my_uart_int_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN is
  ...
  attribute SOFT_HLUTNM of counter_hit : label is "soft_lutpair12";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN_0 : entity is "counter_modN";
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN_0;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN_0 is
  signal count : STD_LOGIC_VECTOR ( 3 downto 0 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN__parameterized4\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN__parameterized4\ : entity is "counter_modN";
end \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN__parameterized4\;

architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN__parameterized4\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S_AXI_INTR is
  port (
    axi_wready_reg_0 : out STD_LOGIC;
    axi_awready_reg_0 : out STD_LOGIC;
    axi_arready_reg_0 : out STD_LOGIC;
    \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg\ : out STD_LOGIC;
    irq : out STD_LOGIC;
    s_axi_intr_bvalid : out STD_LOGIC;
    axi_rvalid_reg_0 : out STD_LOGIC;
    s_axi_intr_rdata : out STD_LOGIC_VECTOR ( 1 downto 0 );
    s_axi_intr_aclk : in STD_LOGIC;
    \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg[1]_0\ : in STD_LOGIC;
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S_AXI_INTR;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S_AXI_INTR is
  ...
  signal \gen_intr_reg[1].reg_intr_sts[1]_i_1_n_0\ : STD_LOGIC;
  ...
  signal or_reduction2_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \axi_arready_i_1__0\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of axi_awready_i_2 : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \axi_rdata[0]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \axi_rdata[1]_i_3\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \axi_rdata[1]_i_5\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \axi_rvalid_i_1__0\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \axi_wready_i_1__0\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \gen_intr_reg[0].reg_intr_ack[0]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \gen_intr_reg[1].reg_intr_ack[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of intr_ack_all_i_1 : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of intr_all_i_1 : label is "soft_lutpair24";
begin
  axi_arready_reg_0 <= \^axi_arready_reg_0\;
  axi_awready_reg_0 <= \^axi_awready_reg_0\;
  axi_rvalid_reg_0 <= \^axi_rvalid_reg_0\;
  axi_wready_reg_0 <= \^axi_wready_reg_0\;
  \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg\ <= \^gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg\;
  irq <= \^irq\;
...
\axi_rdata[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => sel0(1),
      I2 => \gen_intr_reg[0].reg_intr_en_reg_n_0_[0]\,
      I3 => sel0(0),
...
\gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_intr_aclk,
      CE => '1',
      D => \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg[1]_0\,
      Q => \^gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg\,
      R => \gen_intr_reg[1].reg_intr_sts[1]_i_1_n_0\
    );
...
\gen_intr_reg[0].reg_intr_ack[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I3 => s_axi_intr_aresetn,
      I4 => \gen_intr_reg[0].reg_intr_ack_reg_n_0_[0]\,
...
\gen_intr_reg[1].reg_intr_sts[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      ...
      O => \gen_intr_reg[1].reg_intr_sts[1]_i_1_n_0\
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_cu is
  port (
    ...
    clock_out : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
    \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg\ : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_cu is
  ...
  attribute SOFT_HLUTNM of \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr[1]_i_1\ : label is "soft_lutpair11";
begin
...
bit_counter: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN__parameterized4\
     port map (
      AR(0) => reset_8count,
      D(0) => bit_counter_n_3,
      E(0) => shift_en,
...
counter_mod16: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN_0
     port map (
...
\gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
      ...
      I2 => \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg\,
...
TX_counter: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN
     port map (
      ...
      \FSM_sequential_current_state_reg[1]\ => TX_counter_n_0,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART is
  port (
    ...
    \axi_rdata_reg[8]\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
    axi_araddr : in STD_LOGIC_VECTOR ( 1 downto 0 );
    rx : in STD_LOGIC;
    \axi_rdata_reg[2]\ : in STD_LOGIC
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART is
  ...
  signal slv_reg3_out : STD_LOGIC_VECTOR ( 1 to 1 );
...
Holding_register: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_d_ff_register
     port map (
      ...
      D(0) => D(0),
      Q(5 downto 1) => Q(7 downto 3),
      Q(0) => Q(0),
      SS(0) => \^sr\(0),
      axi_araddr(1 downto 0) => axi_araddr(1 downto 0),
      \axi_araddr_reg[3]\ => Holding_register_n_7,
      \axi_rdata_reg[7]\(5 downto 1) => \axi_rdata_reg[8]\(6 downto 2),
      \axi_rdata_reg[7]\(0) => \axi_rdata_reg[8]\(0),
      \q_reg[1]_0\(0) => slv_reg3_out(1),
...
RX_UART: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_cu
     port map (
      ...
      \FSM_onehot_current_state_reg[6]_0\ => \FSM_onehot_current_state_reg[6]\,
      Q(1) => Q(8),
      Q(0) => Q(1),
      SS(0) => \^sr\(0),
      axi_araddr(1 downto 0) => axi_araddr(1 downto 0),
      ...
      \axi_rdata_reg[2]_0\ => \axi_rdata_reg[2]\,
      \axi_rdata_reg[8]\(1) => \axi_rdata_reg[8]\(7),
...
TX_UART: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_tx_cu
     port map (
      CLK => tx_clock,
      \FSM_sequential_current_state_reg[0]_0\(0) => \axi_rdata_reg[8]\(0),
      Q(7 downto 0) => Q(7 downto 0),
      SS(0) => \^sr\(0),
      s00_axi_aresetn => s00_axi_aresetn,
      tx => tx
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S00_AXI is
  port (
    axi_wready_reg_0 : out STD_LOGIC;
    axi_awready_reg_0 : out STD_LOGIC;
    axi_arready_reg_0 : out STD_LOGIC;
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S00_AXI;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S00_AXI is
...
inst_uart: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART
     port map (
      ...
      \axi_rdata_reg[8]\(7) => \slv_reg1_reg_n_0_[8]\,
      \axi_rdata_reg[8]\(6) => \slv_reg1_reg_n_0_[7]\,
      \axi_rdata_reg[8]\(5) => \slv_reg1_reg_n_0_[6]\,
      \axi_rdata_reg[8]\(4) => \slv_reg1_reg_n_0_[5]\,
      \axi_rdata_reg[8]\(3) => \slv_reg1_reg_n_0_[4]\,
      \axi_rdata_reg[8]\(2) => \slv_reg1_reg_n_0_[3]\,
      \axi_rdata_reg[8]\(1) => \slv_reg1_reg_n_0_[1]\,
      \axi_rdata_reg[8]\(0) => slv_reg1(0),
      \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg\ => \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg\,
      rx => rx,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_aresetn => s00_axi_aresetn,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0 is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0 is
  signal \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg\ : STD_LOGIC;
  signal my_uart_int_v1_0_S00_AXI_inst_n_5 : STD_LOGIC;
begin
my_uart_int_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S00_AXI
     port map (
      \FSM_onehot_current_state_reg[6]\ => my_uart_int_v1_0_S00_AXI_inst_n_5,
...
my_uart_int_v1_0_S_AXI_INTR_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S_AXI_INTR
     port map (
      ...
      \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg\ => \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg\,
      \gen_intr_detection[1].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg[1]_0\ => my_uart_int_v1_0_S00_AXI_inst_n_5,
      irq => irq,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_my_uart_int_0_0,my_uart_int_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "my_uart_int_v1_0,Vivado 2018.3";
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0
     port map (
      axi_rvalid_reg => s_axi_intr_rvalid,
      irq => irq,
      rx => rx,
      s00_axi_aclk => s00_axi_aclk,
