...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = my_uart_int_0
 PARAMETER clock-names =  s_axi_intr_aclk s00_axi_aclk
 PARAMETER clocks = clkc 15>, <&clkc 15
 PARAMETER compatible = xlnx,my-uart-int-1.0
 PARAMETER interrupt-names =  irq
 PARAMETER interrupt-parent = intc
 PARAMETER interrupts = 0 29 4
 PARAMETER reg = 0x43c00000 0x10000 0x43c10000 0x10000
 PARAMETER xlnx,intr-active-state = 0x7FFFFFFE
 PARAMETER xlnx,intr-sensitivity = 0x0FFFFFFC
 PARAMETER xlnx,irq-active-state = 1
 PARAMETER xlnx,irq-sensitivity = 1
 PARAMETER xlnx,num-of-intr = 2
