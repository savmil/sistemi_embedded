...
HD_PWD='/home/michele/Documenti/Universita/SE/Projects/UART_int/UART_int.runs/design_1_my_uart_int_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_my_uart_int_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_my_uart_int_0_0.tcl
