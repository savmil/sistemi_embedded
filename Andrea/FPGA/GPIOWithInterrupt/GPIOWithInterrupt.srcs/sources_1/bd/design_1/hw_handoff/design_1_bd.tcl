...
proc create_root_design { parentCell } {
  ...
  set GPIO_0 [ create_bd_cell -type ip -vlnv user.org:user:GPIO:1.0 GPIO_0 ]

  # Create instance: GPIO_1, and set properties
  set GPIO_1 [ create_bd_cell -type ip -vlnv user.org:user:GPIO:1.0 GPIO_1 ]

  # Create instance: GPIO_2, and set properties
  set GPIO_2 [ create_bd_cell -type ip -vlnv user.org:user:GPIO:1.0 GPIO_2 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins GPIO_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins GPIO_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins GPIO_2/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net GPIO_0_interrupt [get_bd_pins GPIO_0/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net GPIO_1_interrupt [get_bd_pins GPIO_1/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net GPIO_2_interrupt [get_bd_pins GPIO_2/interrupt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net Net [get_bd_ports pads_0] [get_bd_pins GPIO_0/pads]
  connect_bd_net -net Net1 [get_bd_ports pads_1] [get_bd_pins GPIO_1/pads]
  connect_bd_net -net Net2 [get_bd_ports pads_2] [get_bd_pins GPIO_2/pads]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins GPIO_0/s00_axi_aclk] [get_bd_pins GPIO_1/s00_axi_aclk] [get_bd_pins GPIO_2/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins GPIO_0/s00_axi_aresetn] [get_bd_pins GPIO_1/s00_axi_aresetn] [get_bd_pins GPIO_2/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs GPIO_0/S00_AXI/S00_AXI_reg] SEG_GPIO_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs GPIO_1/S00_AXI/S00_AXI_reg] SEG_GPIO_1_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs GPIO_2/S00_AXI/S00_AXI_reg] SEG_GPIO_2_S00_AXI_reg
