...
-- Date        : Tue Jul  2 19:05:01 2019
-- Host        : andrea-X580VD running 64-bit Ubuntu 18.04.2 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_UART_1_0_sim_netlist.vhdl
-- Design      : design_1_UART_1_0
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_shift_register is
  port (
    tx : out STD_LOGIC;
    \tmp_sig_reg[9]_0\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
    current_state : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_shift_register is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \tmp_sig[0]_i_3\ : label is "soft_lutpair15";
...
\tmp_sig[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \tmp_sig_reg[9]_0\(5),
      I2 => \tmp_sig_reg[9]_0\(7),
      I3 => \tmp_sig_reg[9]_0\(3),
      I4 => \tmp_sig_reg[9]_0\(6),
...
\tmp_sig[9]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6996"
        ...
        port map (
      I0 => \tmp_sig_reg[9]_0\(2),
      I1 => \tmp_sig_reg[9]_0\(1),
      I2 => \tmp_sig_reg[9]_0\(0),
      I3 => \tmp_sig_reg[9]_0\(4),
      O => \tmp_sig[9]_i_2_n_0\
    );
...
\axi_rdata[2]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6996"
        ...
        port map (
      I0 => \^tmp_sig_reg[7]_0\(6),
      I1 => \^tmp_sig_reg[7]_0\(5),
      I2 => \^tmp_sig_reg[7]_0\(1),
      I3 => \^tmp_sig_reg[7]_0\(3),
...
\axi_rdata[2]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6996"
        ...
        port map (
      I0 => \^tmp_sig_reg[7]_0\(4),
      I1 => \^tmp_sig_reg[7]_0\(2),
      I2 => rx_frame(8),
      I3 => \^tmp_sig_reg[7]_0\(0),
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_cu is
  port (
    D : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \FSM_onehot_current_state_reg[5]_0\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_cu is
  ...
  signal \^fsm_onehot_current_state_reg[5]_0\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \^sr\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute SOFT_HLUTNM of \axi_rdata[2]_i_7\ : label is "soft_lutpair11";
begin
  \FSM_onehot_current_state_reg[5]_0\(1 downto 0) <= \^fsm_onehot_current_state_reg[5]_0\(1 downto 0);
  SR(0) <= \^sr\(0);
\FSM_onehot_current_state[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
        ...
        port map (
      I0 => \^fsm_onehot_current_state_reg[5]_0\(1),
      I1 => rx,
      I2 => reset_8count,
...
RX_shift_register_SIPO: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_shift_register_SIPO
     port map (
      ...
      Q(0) => Q(0),
      SR(0) => \^sr\(0),
      \axi_rdata[1]_i_2_0\(1 downto 0) => \^fsm_onehot_current_state_reg[5]_0\(1 downto 0),
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_tx_cu is
  port (
    ...
    tx : out STD_LOGIC;
    tx_clock : in STD_LOGIC;
    \tmp_sig_reg[9]\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
    s00_axi_aresetn : in STD_LOGIC;
    r0_input : in STD_LOGIC;
    r1_input : in STD_LOGIC;
    SS : in STD_LOGIC_VECTOR ( 0 to 0 )
...
TX_shift_register: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_shift_register
     port map (
      SS(0) => SS(0),
      current_state(1 downto 0) => current_state(1 downto 0),
      \tmp_sig_reg[9]_0\(7 downto 0) => \tmp_sig_reg[9]\(7 downto 0),
      tx => tx,
      tx_clock => tx_clock
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART is
  port (
    ...
    \FSM_sequential_current_state_reg[0]\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    tx : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART is
  signal \^fsm_sequential_current_state_reg[0]\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \^sr\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  signal tx_clock : STD_LOGIC;
begin
  \FSM_sequential_current_state_reg[0]\(1 downto 0) <= \^fsm_sequential_current_state_reg[0]\(1 downto 0);
  SR(0) <= \^sr\(0);
...
Holding_register: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_d_ff_register
     port map (
      ...
      \axi_rdata_reg[4]_0\(1 downto 0) => \^fsm_sequential_current_state_reg[0]\(1 downto 0),
      ...
      \axi_rdata_reg[7]_0\(5 downto 1) => \tmp_sig_reg[9]\(7 downto 3),
      \axi_rdata_reg[7]_0\(0) => \tmp_sig_reg[9]\(0),
...
RX_UART: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_cu
     port map (
      ...
      \FSM_onehot_current_state_reg[5]_0\(1) => \^fsm_sequential_current_state_reg[0]\(0),
      \FSM_onehot_current_state_reg[5]_0\(0) => load_data,
      Q(0) => Q(1),
      SR(0) => \^sr\(0),
      \axi_rdata_reg[1]\ => \axi_rdata_reg[1]\,
      \axi_rdata_reg[1]_0\(0) => \tmp_sig_reg[9]\(1),
      \axi_rdata_reg[2]\(1 downto 0) => data3(2 downto 1),
...
TX_UART: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_tx_cu
     port map (
      \FSM_sequential_current_state_reg[0]_0\(0) => \^fsm_sequential_current_state_reg[0]\(1),
      SS(0) => \^sr\(0),
      r0_input => r0_input,
      r1_input => r1_input,
      s00_axi_aresetn => s00_axi_aresetn,
      \tmp_sig_reg[9]\(7 downto 0) => \tmp_sig_reg[9]\(7 downto 0),
      tx => tx,
      tx_clock => tx_clock
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_v1_0_S00_AXI is
  ...
  signal \changed_bits__3\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute SOFT_HLUTNM of \slv_reg1[11]_i_1\ : label is "soft_lutpair23";
  ...
  attribute SOFT_HLUTNM of \slv_reg1[15]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \slv_reg1[16]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \slv_reg1[17]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \slv_reg1[18]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \slv_reg1[19]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \slv_reg1[20]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \slv_reg1[21]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \slv_reg1[22]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \slv_reg1[23]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \slv_reg1[24]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \slv_reg1[25]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \slv_reg1[26]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \slv_reg1[27]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \slv_reg1[28]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \slv_reg1[29]_i_1\ : label is "soft_lutpair32";
  ...
  attribute SOFT_HLUTNM of \slv_reg7[0]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \slv_reg7[1]_i_1\ : label is "soft_lutpair25";
begin
...
inst_uart: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART
     port map (
      ...
      \FSM_sequential_current_state_reg[0]\(1) => tx_busy,
      \FSM_sequential_current_state_reg[0]\(0) => RDA,
      ...
      s00_axi_aresetn => s00_axi_aresetn,
      sel0(2 downto 0) => sel0(2 downto 0),
      \tmp_sig_reg[9]\(7 downto 0) => slv_reg0(7 downto 0),
      tx => tx
    );
...
\pending_intr[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"A8FF8888"
        ...
        port map (
      I0 => \slv_reg4_reg_n_0_[0]\,
      I1 => \changed_bits__3\(0),
      I2 => \changed_bits__3\(1),
      I3 => slv_reg7(0),
      I4 => slv_reg7_out(0),
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_UART_1_0,UART_v1_0,{}";
