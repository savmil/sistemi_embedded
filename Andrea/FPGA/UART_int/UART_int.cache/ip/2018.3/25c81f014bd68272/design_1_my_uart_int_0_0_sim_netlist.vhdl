...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_tx_cu is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_1\ : label is "soft_lutpair15";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \gen_intr_detection[0].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff[0]_i_2\ : label is "soft_lutpair15";
begin
...
TX_counter: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN
     port map (
      CLK => CLK,
      \FSM_sequential_current_state_reg[0]\(0) => \axi_rdata_reg[4]_0\(0),
...
Holding_register: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_d_ff_register
     port map (
      ...
      \axi_rdata_reg[7]\(4 downto 2) => \axi_rdata_reg[8]\(6 downto 4),
      \axi_rdata_reg[7]\(1) => \axi_rdata_reg[8]\(2),
...
TX_UART: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_tx_cu
     port map (
      ...
      \axi_rdata_reg[4]_0\(1) => \axi_rdata_reg[8]\(3),
      \axi_rdata_reg[4]_0\(0) => \axi_rdata_reg[8]\(0),
      s00_axi_aresetn => s00_axi_aresetn,
      tx => tx,
      tx_busy_to_intr => tx_busy_to_intr
    );
