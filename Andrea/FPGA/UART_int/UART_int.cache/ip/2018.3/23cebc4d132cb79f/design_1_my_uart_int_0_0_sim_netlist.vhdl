...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S_AXI_INTR is
  ...
  signal \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.det_intr[1]_i_1_n_0\ : STD_LOGIC;
  signal \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.det_intr_reg\ : STD_LOGIC;
  signal \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff[1]_i_1_n_0\ : STD_LOGIC;
  signal \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff_reg_n_0_[1]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_araddr[4]_i_1\ : label is "soft_lutpair23";
...
\gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.det_intr[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F4"
    )
        port map (
      I0 => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff_reg_n_0_[1]\,
      I1 => p_1_in4_in,
      I2 => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.det_intr_reg\,
      O => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.det_intr[1]_i_1_n_0\
    );
\gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.det_intr_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_intr_aclk,
      CE => '1',
      D => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.det_intr[1]_i_1_n_0\,
      Q => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.det_intr_reg\,
      R => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff[1]_i_1_n_0\
    );
\gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff2_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_intr_aclk,
      CE => '1',
      D => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff_reg_n_0_[1]\,
      Q => p_1_in4_in,
      R => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff[1]_i_1_n_0\
    );
\gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
      ...
      I1 => s_axi_intr_aresetn,
      O => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff[1]_i_1_n_0\
    );
\gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_intr_aclk,
      CE => '1',
      D => rda_to_intr,
      Q => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff_reg_n_0_[1]\,
      R => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff[1]_i_1_n_0\
    );
...
\gen_intr_reg[1].reg_intr_sts_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_intr_aclk,
      CE => '1',
      D => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.det_intr_reg\,
      Q => p_1_in9_in,
      R => \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff[1]_i_1_n_0\
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_cu is
  ...
  attribute SOFT_HLUTNM of \gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff[1]_i_2\ : label is "soft_lutpair11";
begin
...
\gen_intr_detection[1].gen_intr_edge_detect.gen_intr_falling_edge_detect.intr_ff[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
