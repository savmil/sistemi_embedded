...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S_AXI_INTR is
  ...
  attribute SOFT_HLUTNM of \axi_rdata[0]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \axi_rdata[0]_i_5\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \axi_rvalid_i_1__0\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \axi_wready_i_1__0\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \gen_intr_reg[0].reg_global_intr_en[0]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of intr_ack_all_i_1 : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of intr_all_i_1 : label is "soft_lutpair23";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_cu is
  ...
  attribute SOFT_HLUTNM of \gen_intr_detection[0].gen_intr_level_detect.gen_intr_active_high_detect.det_intr[0]_i_1\ : label is "soft_lutpair11";
begin
...
\gen_intr_detection[0].gen_intr_level_detect.gen_intr_active_high_detect.det_intr[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
my_uart_int_v1_0_S_AXI_INTR_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S_AXI_INTR
     port map (
      ...
      det_intr => det_intr,
      \gen_intr_detection[0].gen_intr_level_detect.gen_intr_active_high_detect.det_intr_reg[0]_0\ => my_uart_int_v1_0_S00_AXI_inst_n_5,
      irq => irq,
