...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_falling_edge_detector is
  port (
    reset : out STD_LOGIC;
    tx_busy_to_intr_1 : out STD_LOGIC;
    tx_busy_to_intr : in STD_LOGIC;
    s_axi_intr_aclk : in STD_LOGIC;
    s_axi_intr_aresetn : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_falling_edge_detector;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_falling_edge_detector is
  signal r0_input : STD_LOGIC;
  signal r1_input : STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S_AXI_INTR is
  ...
  signal tx_busy_to_intr_1 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
...
inst_edge_det: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector
     port map (
...
inst_fall_edge_det: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_falling_edge_detector
     port map (
      reset => reset,
      s_axi_intr_aclk => s_axi_intr_aclk,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_cu is
  ...
  attribute SOFT_HLUTNM of \r0_input_i_1__0\ : label is "soft_lutpair11";
begin
...
\r0_input_i_1__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_tx_cu is
  ...
  attribute SOFT_HLUTNM of r0_input_i_1 : label is "soft_lutpair16";
begin
  tx_busy_to_intr <= \^tx_busy_to_intr\;
...
inst_edge_detector: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_0
     port map (
      Q(0) => Q(0),
      SR(0) => \^sr\(0),
      r0_input => r0_input,
