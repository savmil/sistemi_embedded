...
inst_fall_edge_det: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_0
     port map (
      reset => reset,
      s_axi_intr_aclk => s_axi_intr_aclk,
...
inst_edge_detector: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_1
     port map (
      Q(0) => Q(0),
      SR(0) => \^sr\(0),
      r0_input => r0_input,
