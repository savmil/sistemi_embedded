...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter_modN is
  ...
  attribute SOFT_HLUTNM of counter_hit : label is "soft_lutpair11";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_shift_register is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \tmp_sig[0]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \tmp_sig[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \tmp_sig[2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \tmp_sig[9]_i_3\ : label is "soft_lutpair14";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_int_v1_0_S_AXI_INTR is
  component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Detector is
  port (
    clock : in STD_LOGIC;
    into_detect : in STD_LOGIC_VECTOR ( 1 downto 0 );
    changes : out STD_LOGIC_VECTOR ( 1 downto 0 );
    trigger : out STD_LOGIC
  );
  end component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Detector;
  ...
  signal \gen_intr_detection[0].gen_irq_edge.irq_rising_edge.s_irq_lvl_ff_i_1_n_0\ : STD_LOGIC;
  signal \gen_intr_detection[0].gen_irq_edge.irq_rising_edge.s_irq_lvl_i_1_n_0\ : STD_LOGIC;
  ...
  signal NLW_tx_busy_detector_changes_UNCONNECTED : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_araddr[4]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \axi_rdata[0]_i_3\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \axi_rdata[0]_i_5\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \axi_rvalid_i_1__0\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \axi_wready_i_1__0\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \gen_intr_reg[0].reg_global_intr_en[0]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of intr_ack_all_i_1 : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of intr_all_i_1 : label is "soft_lutpair22";
  attribute width : integer;
  attribute width of tx_busy_detector : label is 2;
begin
...
\gen_intr_detection[0].gen_irq_edge.irq_rising_edge.s_irq_lvl_ff_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => intr_ack_all,
      O => \gen_intr_detection[0].gen_irq_edge.irq_rising_edge.s_irq_lvl_ff_i_1_n_0\
    );
\gen_intr_detection[0].gen_irq_edge.irq_rising_edge.s_irq_lvl_ff_reg\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_intr_aclk,
      CE => '1',
      D => \gen_intr_detection[0].gen_irq_edge.irq_rising_edge.s_irq_lvl_ff_i_1_n_0\,
      Q => s_irq_lvl_ff,
      R => '0'
    );
\gen_intr_detection[0].gen_irq_edge.irq_rising_edge.s_irq_lvl_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000EA00"
    )
        port map (
      ...
      I4 => intr_ack_all,
      O => \gen_intr_detection[0].gen_irq_edge.irq_rising_edge.s_irq_lvl_i_1_n_0\
    );
\gen_intr_detection[0].gen_irq_edge.irq_rising_edge.s_irq_lvl_reg\: unisim.vcomponents.FDRE
     port map (
      C => s_axi_intr_aclk,
      CE => '1',
      D => \gen_intr_detection[0].gen_irq_edge.irq_rising_edge.s_irq_lvl_i_1_n_0\,
      Q => s_irq_lvl,
      R => '0'
    );
...
tx_busy_detector: component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Detector
     port map (
      changes(1 downto 0) => NLW_tx_busy_detector_changes_UNCONNECTED(1 downto 0),
      clock => s_axi_intr_aclk,
      into_detect(1 downto 0) => B"00",
      trigger => intr
    );
end STRUCTURE;
library IEEE;
