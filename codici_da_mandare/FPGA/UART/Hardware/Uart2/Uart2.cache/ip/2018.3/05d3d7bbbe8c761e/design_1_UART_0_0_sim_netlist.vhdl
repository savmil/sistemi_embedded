...
\axi_rdata[2]_i_6\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \^tmp_sig_reg[7]_0\(5),
      I3 => \^tmp_sig_reg[7]_0\(6),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_v1_0_S00_AXI is
  ...
  signal \pending_intr[0]_i_2_n_0\ : STD_LOGIC;
...
\pending_intr[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\pending_intr[1]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => current_stage(0),
      I1 => \slv_reg5_reg_n_0_[1]\,
      I2 => \last_stage_reg_n_0_[0]\,
      I3 => \last_stage_reg_n_0_[1]\,
