...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_UART_1_0 -prefix
--               design_1_UART_1_0_ design_1_UART_0_0_sim_netlist.vhdl
...
entity design_1_UART_1_0_clock_mod is
  port (
    CLK : out STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC
  );
end design_1_UART_1_0_clock_mod;

architecture STRUCTURE of design_1_UART_1_0_clock_mod is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_UART_1_0_clock_mod__parameterized1\ is
  port (
    tx_clock : out STD_LOGIC;
    CLK : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_UART_1_0_clock_mod__parameterized1\ : entity is "clock_mod";
end \design_1_UART_1_0_clock_mod__parameterized1\;

architecture STRUCTURE of \design_1_UART_1_0_clock_mod__parameterized1\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_UART_1_0_counter_modN is
  port (
...
end design_1_UART_1_0_counter_modN;

architecture STRUCTURE of design_1_UART_1_0_counter_modN is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_UART_1_0_counter_modN__parameterized1\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_UART_1_0_counter_modN__parameterized1\ : entity is "counter_modN";
end \design_1_UART_1_0_counter_modN__parameterized1\;

architecture STRUCTURE of \design_1_UART_1_0_counter_modN__parameterized1\ is
  signal count : STD_LOGIC_VECTOR ( 2 downto 0 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_UART_1_0_counter_modN__parameterized3\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_UART_1_0_counter_modN__parameterized3\ : entity is "counter_modN";
end \design_1_UART_1_0_counter_modN__parameterized3\;

architecture STRUCTURE of \design_1_UART_1_0_counter_modN__parameterized3\ is
  signal count : STD_LOGIC_VECTOR ( 3 downto 0 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_UART_1_0_counter_modN__parameterized5\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_UART_1_0_counter_modN__parameterized5\ : entity is "counter_modN";
end \design_1_UART_1_0_counter_modN__parameterized5\;

architecture STRUCTURE of \design_1_UART_1_0_counter_modN__parameterized5\ is
  signal count : STD_LOGIC_VECTOR ( 3 downto 0 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_UART_1_0_d_ff_register is
  port (
...
end design_1_UART_1_0_d_ff_register;

architecture STRUCTURE of design_1_UART_1_0_d_ff_register is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_UART_1_0_edge_detector is
  port (
...
end design_1_UART_1_0_edge_detector;

architecture STRUCTURE of design_1_UART_1_0_edge_detector is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_UART_1_0_shift_register is
  port (
    tx : out STD_LOGIC;
    current_state : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
end design_1_UART_1_0_shift_register;

architecture STRUCTURE of design_1_UART_1_0_shift_register is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_UART_1_0_shift_register_SIPO is
  port (
...
end design_1_UART_1_0_shift_register_SIPO;

architecture STRUCTURE of design_1_UART_1_0_shift_register_SIPO is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_UART_1_0_rx_cu is
  port (
    D : out STD_LOGIC_VECTOR ( 0 to 0 );
    \axi_araddr_reg[3]\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
...
end design_1_UART_1_0_rx_cu;

architecture STRUCTURE of design_1_UART_1_0_rx_cu is
...
RX_shift_register_SIPO: entity work.design_1_UART_1_0_shift_register_SIPO
     port map (
      CLK => CLK,
      E(0) => shift_en,
...
bit_counter: entity work.\design_1_UART_1_0_counter_modN__parameterized5\
     port map (
      CLK => CLK,
      D(0) => bit_counter_n_2,
      E(0) => shift_en,
...
counter_mod16: entity work.\design_1_UART_1_0_counter_modN__parameterized3\
     port map (
      CLK => CLK,
...
counter_mod8: entity work.\design_1_UART_1_0_counter_modN__parameterized1\
     port map (
      CLK => CLK,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_UART_1_0_tx_cu is
  port (
    D : out STD_LOGIC_VECTOR ( 0 to 0 );
...
end design_1_UART_1_0_tx_cu;

architecture STRUCTURE of design_1_UART_1_0_tx_cu is
...
TX_counter: entity work.design_1_UART_1_0_counter_modN
     port map (
...
TX_shift_register: entity work.design_1_UART_1_0_shift_register
     port map (
      SS(0) => SS(0),
      current_state(1 downto 0) => current_state(1 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_UART_1_0_UART is
  port (
    SR : out STD_LOGIC_VECTOR ( 0 to 0 );
    D : out STD_LOGIC_VECTOR ( 1 downto 0 );
...
end design_1_UART_1_0_UART;

architecture STRUCTURE of design_1_UART_1_0_UART is
...
begin
  ...
  SR(0) <= \^sr\(0);
BAUDGENERATOR: entity work.design_1_UART_1_0_clock_mod
     port map (
      CLK => clock_out,
      s00_axi_aclk => s00_axi_aclk
    );
Holding_register: entity work.design_1_UART_1_0_d_ff_register
     port map (
      D(0) => \^d\(0),
...
RX_UART: entity work.design_1_UART_1_0_rx_cu
     port map (
      CLK => clock_out,
      D(0) => \^d\(0),
...
TX_UART: entity work.design_1_UART_1_0_tx_cu
     port map (
      D(0) => \^d\(1),
...
inst_edge_detector: entity work.design_1_UART_1_0_edge_detector
     port map (
      Q(0) => Q(0),
      SR(0) => \^sr\(0),
      r0_input => r0_input,
...
tx_clock_mod: entity work.\design_1_UART_1_0_clock_mod__parameterized1\
     port map (
      CLK => clock_out,
      tx_clock => tx_clock
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_UART_1_0_UART_v1_0_S00_AXI is
  port (
...
end design_1_UART_1_0_UART_v1_0_S00_AXI;

architecture STRUCTURE of design_1_UART_1_0_UART_v1_0_S00_AXI is
...
inst_uart: entity work.design_1_UART_1_0_UART
     port map (
      D(1) => tx_busy,
      D(0) => inst_uart_n_2,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_UART_1_0_UART_v1_0 is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    tx : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
...
end design_1_UART_1_0_UART_v1_0;

architecture STRUCTURE of design_1_UART_1_0_UART_v1_0 is
begin
UART_v1_0_S00_AXI_inst: entity work.design_1_UART_1_0_UART_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
entity design_1_UART_1_0 is
  ...
  attribute NotValidForBitStream of design_1_UART_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_UART_1_0 : entity is "design_1_UART_0_0,UART_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_UART_1_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_UART_1_0 : entity is "UART_v1_0,Vivado 2018.3";
end design_1_UART_1_0;

architecture STRUCTURE of design_1_UART_1_0 is
...
U0: entity work.design_1_UART_1_0_UART_v1_0
     port map (
