...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = myled_controller
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myled_controller_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myled_controller
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myled_controller_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myled_controller
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myled_controller_2
END
