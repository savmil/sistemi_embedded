...
HD_PWD='/home/saverio/saverio/zybo/prova_zybo_os/prova_zybo_os.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpu_wrapper.tcl -notrace
