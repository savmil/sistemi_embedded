...
HD_PWD='/home/saverio/saverio/zybo/prova_zybo_os/prova_zybo_os.runs/cpu_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_axi_gpio_0_0.tcl
