...
HD_PWD='/home/saverio/saverio/zybo/prova_zybo_os/prova_zybo_os.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_wrapper.tcl
