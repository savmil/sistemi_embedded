...
HD_PWD='/home/saverio/GPIO_ARRAY/gpio_array.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_arr_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio_arr_wrapper.tcl -notrace
