...
HD_PWD='/home/saverio/GPIO_ARRAY/gpio_array.runs/gpio_arr_vio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_arr_vio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_arr_vio_0_1.tcl
