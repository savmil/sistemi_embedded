...
HD_PWD='/home/saverio/GPIO_ARRAY/gpio_array.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_arr_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_arr_wrapper.tcl
