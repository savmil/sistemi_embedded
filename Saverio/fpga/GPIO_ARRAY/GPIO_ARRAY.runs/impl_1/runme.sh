...
HD_PWD='/home/saverio/zybo/GPIO_ARRAY/GPIO_ARRAY.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_array.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio_array.tcl -notrace
