...
HD_PWD='/home/saverio/zybo/GPIO_ARRAY/GPIO_ARRAY.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_array.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_array.tcl
